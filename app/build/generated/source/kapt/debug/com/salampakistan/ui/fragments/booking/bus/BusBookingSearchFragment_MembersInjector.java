...
public final class BusBookingSearchFragment_MembersInjector implements MembersInjector<BusBookingSearchFragment> {
  ...
  public BusBookingSearchFragment_MembersInjector(Provider<Preferences> preferencesProvider,
  ...
  public static MembersInjector<BusBookingSearchFragment> create(
      Provider<Preferences> preferencesProvider, Provider<DialogUtils> dialogUtilsProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new BusBookingSearchFragment_MembersInjector(preferencesProvider, dialogUtilsProvider, viewModelFactoryProvider);}

  @Override
  public void injectMembers(BusBookingSearchFragment instance) {
