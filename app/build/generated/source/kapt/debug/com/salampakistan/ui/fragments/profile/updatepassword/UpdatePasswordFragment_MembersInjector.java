...
public final class UpdatePasswordFragment_MembersInjector implements MembersInjector<UpdatePasswordFragment> {
  ...
  public UpdatePasswordFragment_MembersInjector(Provider<Preferences> preferencesProvider,
  ...
  public static MembersInjector<UpdatePasswordFragment> create(
      Provider<Preferences> preferencesProvider, Provider<DialogUtils> dialogUtilsProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new UpdatePasswordFragment_MembersInjector(preferencesProvider, dialogUtilsProvider, viewModelFactoryProvider);}

  @Override
  public void injectMembers(UpdatePasswordFragment instance) {
