...
public final class EventDetailsFragment_MembersInjector implements MembersInjector<EventDetailsFragment> {
  ...
  public EventDetailsFragment_MembersInjector(Provider<Preferences> preferencesProvider,
  ...
  public static MembersInjector<EventDetailsFragment> create(
      Provider<Preferences> preferencesProvider, Provider<DialogUtils> dialogUtilsProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new EventDetailsFragment_MembersInjector(preferencesProvider, dialogUtilsProvider, viewModelFactoryProvider);}

  @Override
  public void injectMembers(EventDetailsFragment instance) {
