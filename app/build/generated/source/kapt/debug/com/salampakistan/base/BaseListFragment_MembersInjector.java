...
public final class BaseListFragment_MembersInjector<VDB> implements MembersInjector<BaseListFragment<VDB>> {
  ...
  public BaseListFragment_MembersInjector(Provider<Preferences> preferencesProvider,
  ...
  public static <VDB> MembersInjector<BaseListFragment<VDB>> create(
      Provider<Preferences> preferencesProvider, Provider<DialogUtils> dialogUtilsProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new BaseListFragment_MembersInjector<VDB>(preferencesProvider, dialogUtilsProvider, viewModelFactoryProvider);}

  @Override
  public void injectMembers(BaseListFragment<VDB> instance) {
