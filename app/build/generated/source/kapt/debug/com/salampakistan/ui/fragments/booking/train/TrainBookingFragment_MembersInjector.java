...
public final class TrainBookingFragment_MembersInjector implements MembersInjector<TrainBookingFragment> {
  ...
  public TrainBookingFragment_MembersInjector(Provider<Preferences> preferencesProvider,
  ...
  public static MembersInjector<TrainBookingFragment> create(
      Provider<Preferences> preferencesProvider, Provider<DialogUtils> dialogUtilsProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new TrainBookingFragment_MembersInjector(preferencesProvider, dialogUtilsProvider, viewModelFactoryProvider);}

  @Override
  public void injectMembers(TrainBookingFragment instance) {
