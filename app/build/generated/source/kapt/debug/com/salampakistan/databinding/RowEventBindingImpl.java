...
public class RowEventBindingImpl extends RowEventBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.cardView5, 4);
        sViewsWithIds.put(R.id.read_more_btn, 5);
    }
    // views
    @NonNull
    ...
    public RowEventBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 6, sIncludes, sViewsWithIds));
    }
    private RowEventBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            com.salampakistan.utils.BindingAdaptersKt.setImageUrl(this.roundedImageView, modelThumbnails0);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.textView19, modelStatus);
            androidx.databinding.adapters.TextViewBindingAdapter.setText(this.textView20, modelTitle);
        }
    }
