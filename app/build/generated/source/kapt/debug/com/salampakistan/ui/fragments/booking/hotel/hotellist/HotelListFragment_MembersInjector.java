...
public final class HotelListFragment_MembersInjector implements MembersInjector<HotelListFragment> {
  ...
  public HotelListFragment_MembersInjector(Provider<Preferences> preferencesProvider,
  ...
  public static MembersInjector<HotelListFragment> create(Provider<Preferences> preferencesProvider,
      Provider<DialogUtils> dialogUtilsProvider,
      Provider<ViewModelProvider.Factory> viewModelFactoryProvider) {
    return new HotelListFragment_MembersInjector(preferencesProvider, dialogUtilsProvider, viewModelFactoryProvider);}

  @Override
  public void injectMembers(HotelListFragment instance) {
