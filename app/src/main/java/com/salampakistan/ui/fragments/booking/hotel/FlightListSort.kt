...
class FlightListSort : BottomSheetDialogFragment() {
    ...
    private fun setView() {
        ...
        starArray = ArrayList()
//        starArray.add("5,000 - 10,000")
//        starArray.add("10,000 - 20,000")
//        starArray.add("20,000 - 40,000")
//        starArray.add("above 40,000")
